...
using Gerenciado_de_Usuario_Papido_Facil.Application.Configuration;
using Gerenciado_de_Usuario_Papido_Facil.Application.Hub;
using Gerenciado_de_Usuario_Papido_Facil.Application.Interfaces;
using Gerenciado_de_Usuario_Papido_Facil.Application.Services;
using Gerenciado_de_Usuario_Papido_Facil.Infra;
using Gerenciado_de_Usuario_Papido_Facil.Infra.Data.config.configMigrate;
using Gerenciado_de_Usuario_Papido_Facil.Infra.Data.Interfaces;
using Gerenciado_de_Usuario_Papido_Facil.Infra.Data.Repositories;
using Microsoft.EntityFrameworkCore;

namespace Usuario_Papido_Facil.Api
{
        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<GerenciadorUsuarioDbContext>(options =>
                                                                options.UseMySql(builder.Configuration.GetConnectionString("DefaultConnection"),
                                                                    ...
                                                                    mysqlOptions => mysqlOptions.MigrationsAssembly("Gerenciado-de-Usuario-Papido-Facil.Infra")
